...
class ShowDayliDataPage extends StatelessWidget {
  final Future<AstronomyDailyData> astronomyDailyData;
  const ShowDayliDataPage({Key? key, required this.astronomyDailyData})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('Astronomy Dayli Data 🪐')),
